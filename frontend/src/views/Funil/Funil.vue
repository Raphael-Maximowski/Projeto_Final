<template>
  <main>
    ...
    <div>
      ...
      <div>
        <Draggable @Whatsapp="Whatsapp" @OpenCreate="OpenCreate" @ActiveFromStep="ActiveFromStep" :dadosfunil="dadosfunil"  @ActiveContactMain="ActiveContactMain" @ReceiveIdPost="ReceiveIdPost" @ReceiveId = "ReceiveId" />
      </div>
    </div>
  </main>
</template>
